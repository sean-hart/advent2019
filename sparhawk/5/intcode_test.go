...
func TestAddition(t *testing.T) {
	tests := []testProgram {
		{
			...
			want:  program{ code: []int{2,0,0,0,99}, cur: 0, input: 0, output: 0}, 
		},
	}
	...
	for _, tc := range tests {
		t.Run("Test addition opscode", func(t *testing.T) {
			got := add(tc.input)
			if reflect.DeepEqual(got.code, tc.want.code) != true {
				t.Errorf("Got %d, wanted %d", got.code, tc.want.code)
			}
		})
	}
}
	...
	tests := []testProgram {
		{
			...
			want:  program{ code: []int{1,0,99}, cur: 0, input: 1, output: 0}, 
		},
	}
...
func TestOutput(t *testing.T) {
	tests := []testProgram {
		{
			input: program{ code: []int{4,0,99}, cur: 0, input: 0, output: 0}, 
			want:  program{ code: []int{4,0,99}, cur: 2, input: 0, output: 4}, 
		},
	}
...
func TestIntCode(t *testing.T) {
	tests := []testProgram {
		{
			input: program{ code: []int{2,3,0,3,99}, cur: 0, input: 0, output: 0}, 
			want:  program{ code: []int{2,3,0,6,99}, cur: 4, input: 0, output: 0}, 
		},
		{
			input: program{ code: []int{1,0,0,0,99}, cur: 0, input: 0, output: 0}, 
	...
	for _, tc := range tests {
		t.Run("Test all intcodes", func(t *testing.T) {
...
func TestProgram(t *testing.T) {
	tests := []testProgram {
		...
		{
			input: program{ code: []int{2,3,0,3,3,0,99}, cur: 0, input: 53, output: 0}, 
			want:  program{ code: []int{53,3,0,6,3,0,99}, cur: 6, input: 53, output: 0}, 
		},
		{
			input: program{ code: []int{1,1,1,4,99,5,6,0,99}, cur: 0, input: 0, output: 0}, 
			want:  program{ code: []int{30,1,1,4,2,5,6,0,99}, cur: 8, input: 0, output: 0}, 
		},
		{
