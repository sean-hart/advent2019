...
import (
	...
	. "github.com/sean-hart/advent2019/shart/day06"
...
// 	for i := 0; i < b.N; i++ {
// 		RunProgram(1, day06Input, 0, 0)
// 	}
// }

var _ = Describe("Day 06 pt 1 - Output tests", func() {
	Context("Reading Output", func() {
		DescribeTable("Output",
			func(input string, expectedOutput int) {
				output := CalculateOrbits(input)
